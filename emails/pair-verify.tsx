...
interface PairUpVerifyEmailProps {
    firstName?: string;
    username?: string;
    verifyLink?: string;
  }
...
export const PairUpVerifyEmail = ({
    username = 'fredbrooks',
    firstName = 'Fred',
    verifyLink = 'https://pair-up.org/verify/4323432'
}) => (
    <Html>
        <Head/>
            ...
            <Container style={container}>
                <Section style={primary}>
                    ...
                    <Text style={paragraph}>
                        {firstName}, your {' '}
                        <Link style={anchor} href="https://pair-up.org">
                            Pair Up
                        </Link>{' '}
                        account is all ready to go! Just follow the link below to confirm your email
                        address.
                    </Text>
                    <Button pX={12} pY={12} style={button} href={verifyLink}>
...
export default PairUpVerifyEmail;
